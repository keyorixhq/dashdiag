...
var exitCodeContract = map[string]string{
	...
	"oci":       "todo: OCI guest-config findings not yet wired to the exit code",
	...
	"share":     "exempt: repackages an already-computed diagnosis (live, --from, or --last) into a redacted artifact — the exit code reflects whether the artifact was produced, not host severity",
...
var jsonContract = map[string]string{
	...
	"containerd": "json", "aws": "json", "azure": "json", "gcp": "json", "oci": "json",
