...
type NFSMount struct {
	...
	// ServerCheckSkipped is true when the server-reachability dial (ports 111
	// and 2049) was skipped because DSD_OFFLINE was set, rather than actually
	// attempted and failed — distinguishes "not measured" from a real
	// "server unreachable" finding.
	ServerCheckSkipped bool     `json:"server_check_skipped,omitempty"`
