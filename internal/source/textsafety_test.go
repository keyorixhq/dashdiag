...
// TestSanitizeControl mirrors internal/output's TestSanitizeControl — this is
// a duplicate implementation (see textsafety.go's doc comment for why), so it
// gets the same coverage to keep the two copies behaviorally identical.
